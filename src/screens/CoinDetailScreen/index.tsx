...
const histroyString = JSON.stringify([
  47222.9831719397,
  47434.65047738381,
  47607.369136516856,
  47074.35527848516,
...
import CoinPriceChart from '../../components/CoinPriceGraph';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        ...
        <View>
          <AntDesign name={'star'} size={30} color={'#2f95dc'}/>
        </View>
      </View>
      <View style={styles.currentPriceContainer}>
        ...
        <View style={styles.indexPriceContainer}>
          ...
          <View style={styles.row}>
            ...
            <PercentageChange value={coinData.valueChange7Ds} />
          </View>
        </View>
      </View>
      <CoinPriceChart dataString={histroyString} />
